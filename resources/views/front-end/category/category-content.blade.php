@extends("front-end.master") @section('title') My Shop | Category Product @endsection
@section('body')
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-9 col-md-7">
              ...
              <div class="product__item">
                ...
                >
                  <ul class="product__item__pic__hover">
                    ...
                    <li>
                      <a href="{{ url('product-details', ['id' => $categoryProduct->id]) }}"><i class="fa fa-shopping-cart"></i></a>
                    </li>
                  </ul>
                </div>
        ...
        {{ $AllCategoryProducts->onEachSide(1)->links() }}
      </div>
    </div>
  </div>
</section>
