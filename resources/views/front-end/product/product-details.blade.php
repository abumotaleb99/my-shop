...
<!-- Product Details Section Begin -->
    ...
    <section class="related-product">
        <div class="container">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            <h6><a href="{{ url('product-details', ['id' => $relatedProduct->id]) }}">{{ $relatedProduct->name }}</a></h6>
                            <h5>{{ $relatedProduct->price }} TK</h5>
                        </div>
                    </div>
                </div>
                @endforeach
            @else 
            <div class="col-lg-12">
              <p class="text-center font-weight-bold">No Related Product Found!</p>
            </div>
            @endif
            </div>
        </div>
